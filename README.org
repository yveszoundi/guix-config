...
- The core installation itself is minimal and the user specific software packages feature [[https://github.com/djpohly/dwl/][DWL]] ([[https://dwm.suckless.org/][dwm]] for =Wayland=)
...
This will setup a minimal [[https://arewewaylandyet.com/][Wayland]] graphical environment with [[https://github.com/engstrand-config/dwl-guile][dwl-guile]] (via [[https://guix.gnu.org/manual/devel/en/html_node/Home-Configuration.html][Guix home configuration management]]).
